...
all.installed <- subset(installations,subset=Installed==1,select=c(Package,User))
all.not.installed <- subset(installations,subset=Installed==0,select=c(Package,User))
